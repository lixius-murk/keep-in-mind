...
public class BuyTabFragment extends TabFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (task_location != null && !task_location.isEmpty()) {
            for (String line : task_location.split("\n")) {
                ...
                View itemView = inflater.inflate(R.layout.item_buy, tasksContainer, false);
                TextView nameText = itemView.findViewById(R.id.name_text);
                TextView priceText = itemView.findViewById(R.id.price_text);
